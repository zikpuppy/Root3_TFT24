...
#define NOZZLE_PAUSE_X_POSITION     (X_MIN_POS + 100)  // (mm) Must be an integer
#define NOZZLE_PAUSE_Y_POSITION     (Y_MIN_POS + 100)  // (mm) Must be an integer
...
#define NOZZLE_PAUSE_Z_FEEDRATE     100  // (mm/min) Z axis feedrate
...
#define LEVELING_POINT_Z_FEEDRATE  100   // (mm/min) Z axis move feedrate
...
#define POWER_LOSS_ZRAISE 50 // (mm) Raise Z axis on resume (on power loss with UPS)
...
#define PRINT_START_GCODE "G28 XY R30\n" // Raise Z 10mm before homing X & Y
...
#define CANCEL_PRINT_GCODE "G28 XY R30\n" // Raise Z 10mm before homing X & Y
